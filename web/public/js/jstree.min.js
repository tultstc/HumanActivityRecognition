...
!(function (a) {
    ...
    if (!a.jstree) {
        ...
        !j &&
            ...
            (a.jstree.defaults.core = {
                ...
                keyboard: {
                    ...
                    up: function (a) {
                        ...
                        b &&
                            b.length &&
                            b.children(".jstree-anchor").trigger("focus");
                    },
                    right: function (b) {
                        if (
                            (b.preventDefault(),
            ...
            (a.jstree.core.prototype = {
                            ...
                            function (b) {
                                b.preventDefault(),
                                    b.currentTarget !== i.activeElement &&
                                        a(b.currentTarget).trigger("focus"),
                ...
                _load_nodes: function (a, b, c, d) {
                    ...
                    for (h = 0, i = a.length; i > h; h++)
                        g[a[h]] &&
                            ((!g[a[h]].state.loaded && !g[a[h]].state.failed) ||
                                (!c && d)) &&
                            (this.is_loading(a[h]) || this.load_node(a[h], f),
                            (e = !1));
                    if (e) {
                        for (h = 0, i = a.length; i > h; h++)
                    ...
                    return d
                        ? a.vakata.is_function(d)
                            ...
                            : "object" == typeof d
                              ? d.url
                                  ? ((d = a.extend(!0, {}, d)),
                                    a.vakata.is_function(d.url) &&
                                        (d.url = d.url.call(this, b)),
                                    a.vakata.is_function(d.data) &&
                        ...
                        var f = null,
                            ...
                            i = function (a, b) {
                                ...
                                if (
                                    ...
                                    for (p = 0, q = c.length; q > p; p++)
                                        l[c[p].parent.toString()]
                                            ...
                                            : "undefined" != typeof h &&
                                              ...
                                              h.settings.core.error.call(
                                                  h,
                                                  h._data.core.last_error,
                                              ));
                                    for (
                                        p = 0, q = m.children.length;
                                        q > p;
                                        p++
                                    )
                                        (o = s(
                                    ...
                                    for (
                                        p = 0, q = m.parents.length;
                                        q > p;
                                        p++
                                    )
                                        l[m.parents[p]].children_d =
                                            l[m.parents[p]].children_d.concat(
                                                f,
                                            );
                                    r = {
                                        cnt: k,
                    ...
                    this._model.force_full_redraw &&
                        ...
                        null !== g &&
                            ...
                            d.children(".jstree-anchor")[0] !== i.activeElement
                                ? d.children(".jstree-anchor").trigger("focus")
                                : (this._data.core.focused = null)),
                ...
                redraw_node: function (b, c, d, e) {
                    ...
                    for (
                        f.a_attr.id || (f.a_attr.id = f.id + "_anchor"),
                            ...
                            this.settings.core.compute_elements_positions &&
                                (b.childNodes[1].setAttribute(
                                    "aria-setsize",
                                    p[f.parent].children.length,
                                ),
                                b.childNodes[1].setAttribute(
                                    "aria-posinset",
                                    p[f.parent].children.indexOf(f.id) + 1,
                                )),
                            f.state.disabled &&
                                b.childNodes[1].setAttribute(
                                    "aria-disabled",
                    ...
                    if (
                        ...
                        p[f.parent] &&
                        !f.state.hidden &&
                        ((k = a.inArray(f.id, p[f.parent].children)),
                        (w = f.id),
                        -1 !== k)
                    )
                    ...
                    if (
                        (n.length &&
                            (b.childNodes[1].className = "jstree-anchor " + n),
                        ...
                        for (
                            ...
                            m.appendChild(
                                this.redraw_node(f.children[k], c, !0),
                            );
                        b.appendChild(m);
                    }
                    if ((j && b.appendChild(j), !d)) {
                        for (
                            ...
                            if (
                                ...
                                -1 !==
                                    g.childNodes[k].className.indexOf(
                                        "jstree-children",
                                    )
                            ) {
                                s = g.childNodes[k];
                    ...
                    if (c) {
                        if (
                            ...
                            if (c.core.loaded)
                                return (
                                    this.settings.core.loaded_state &&
                                    a.vakata.is_array(c.core.loaded) &&
            ...
            (a.vakata.trim = function (a) {
                return String.prototype.trim
                    ? String.prototype.trim.call(a.toString())
                    : a
                          .toString()
                          .replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
            }),
            (a.vakata.is_function = function (a) {
        ...
        (l.className = "jstree-icon jstree-checkbox"),
            ...
            (a.jstree.plugins.checkbox = function (c, d) {
                (this.bind = function () {
                    ...
                    (this.redraw_node = function (a, b, c, e) {
                        if ((a = d.redraw_node.apply(this, arguments))) {
                            var f,
                                g,
                                h = null,
                                i = null;
                            for (f = 0, g = a.childNodes.length; g > f; f++)
                                if (
                                    ...
                                    -1 !==
                                        a.childNodes[f].className.indexOf(
                                            "jstree-anchor",
                                        )
                                ) {
                                    h = a.childNodes[f];
                            ...
                            h &&
                                (!this.settings.checkbox.tie_selection &&
                                    this._model.data[a.id].state.checked &&
                                    (h.className += " jstree-checked"),
                                (i = l.cloneNode(!1)),
                                this._model.data[a.id].state
                                    .checkbox_disabled &&
                                    (i.className +=
                                        " jstree-checkbox-disabled"),
                                h.insertBefore(i, h.childNodes[0]));
                        }
                        return (
                            c ||
                                -1 ===
                    ...
                    (this.get_checked_descendants = function (b) {
                        var c = this,
                            ...
                            e = c._model.data[b];
                        return a.vakata.array_filter(
                            e.children_d,
                            function (a) {
                                return c._model.data[a].state[
                                    d ? "selected" : "checked"
                                ];
                            },
                        );
            ...
            (a.jstree.plugins.conditionalselect = function (a, b) {
                this.activate_node = function (a, c) {
                    return this.settings.conditionalselect.call(
                        this,
                        this.get_node(a),
                        c,
                    )
            ...
            (a.jstree.plugins.contextmenu = function (c, d) {
                (this.bind = function () {
                    ...
                    (this.teardown = function () {
                        this._data.contextmenu.visible &&
                            a.vakata.context.hide(),
                            a(i).off("context_hide.vakata.jstree"),
                ...
                (a.vakata.context = {
                    ...
                    _execute: function (b) {
                        return (
                            ...
                            b &&
                            (!b._disabled ||
                                (a.vakata.is_function(b._disabled) &&
                                    !b._disabled({
                                        item: b,
                                        reference: c.reference,
                                        element: c.element,
                                ...
                                return d
                                    ? (c.items.push(d),
                                      ...
                                      (e +=
                                          ...
                                          (d._class || "") +
                                          (d._disabled === !0 ||
                                          (a.vakata.is_function(d._disabled) &&
                                              d._disabled({
                                                  item: d,
                                                  reference: c.reference,
                                                  element: c.element,
        ...
        (a.jstree.plugins.dnd = function (b, c) {
                    ...
                    .on("dnd_move.vakata.jstree", function (h, i) {
                        ...
                        if (
                            ...
                            i &&
                                ...
                                i.data.jstree &&
                                (!i.event.target.id ||
                                    "jstree-marker" !== i.event.target.id))
                        ) {
                            e = i.event;
                            ...
                            if (k && k._data && k._data.dnd)
                                if (
                                    ...
                                    (i.event.target !== k.element[0] &&
                                        i.event.target !==
                                            k.get_container_ul()[0]) ||
                                        0 !==
                                            k.get_container_ul().children()
                                                .length)
                                ) {
                                    if (
                ...
                a.vakata.dnd = {
                    ...
                    _clean: function () {
                        c.helper && c.helper.remove(),
                            c.scroll_i &&
                                (clearInterval(c.scroll_i), (c.scroll_i = !1)),
                            (c = {
                                element: !1,
                                target: !1,
                                is_down: !1,
                        ...
                        try {
                            (b.currentTarget.unselectable = "on"),
                                ...
                                b.currentTarget.style &&
                                    ((b.currentTarget.style.touchAction =
                                        "none"),
                                    (b.currentTarget.style.msTouchAction =
                                        "none"),
                                    (b.currentTarget.style.MozUserSelect =
                                        "none"));
                        } catch (f) {}
                        return (
                            (c.init_x = b.pageX),
                        ...
                        if (!e) {
                            ...
                            if (((this._data.massload = {}), h.length)) {
                                ...
                                if ("object" == typeof g && g && g.url)
                                    return (
                                        (g = a.extend(!0, {}, g)),
                                        a.vakata.is_function(g.url) &&
                                            (g.url = g.url.call(this, h)),
                                        a.vakata.is_function(g.data) &&
                                            (g.data = g.data.call(this, h)),
                                        a
                                            .ajax(g)
                                            .done(
                                                function (a, g, h) {
            ...
            (a.jstree.plugins.search = function (c, d) {
                (this.bind = function () {
                    ...
                    (this.search = function (c, d, e, f, g, h) {
                        if (c === !1 || "" === a.vakata.trim(c.toString()))
            ...
            (a.jstree.plugins.sort = function (a, b) {
                (this.bind = function () {
                    b.bind.call(this),
                        this.element
                            .on(
                    ...
                    (this.sort = function (a, b) {
                        ...
                        if (
                            ...
                            a &&
                                a.children &&
                                a.children.length &&
                                (a.children.sort(this.settings.sort.bind(this)),
                                b))
                        )
                            for (c = 0, d = a.children_d.length; d > c; c++)
                                this.sort(a.children_d[c], !1);
                    });
            });
        var o = !1;
            ...
            (a.jstree.plugins.state = function (b, c) {
                (this.bind = function () {
                    ...
                    this.element.on(
                        "ready.jstree",
                        function (b, c) {
                            this.element.one("restore_state.jstree", a),
                                this.restore_state() || a();
                        }.bind(this),
                    );
                }),
                ...
                (this.init = function (c, e) {
                    ...
                    (this.set_type = function (c, d) {
                        ...
                        if (
                            ...
                            (j === !0 ||
                                !f[i] ||
                                (f[i].icon !== b && j === f[i].icon)) &&
                                this.set_icon(
                                    c,
                                    f[d].icon !== b ? f[d].icon : !0,
                                ),
                            f[i] &&
                                f[i].li_attr !== b &&
                                "object" == typeof f[i].li_attr)
                        )
                            for (k in f[i].li_attr)
                                if (f[i].li_attr.hasOwnProperty(k)) {
                                    ...
                                    "class" === k
                                        ...
                                        : e[c.id].li_attr[k] ===
                                              f[i].li_attr[k] &&
                                          ((e[c.id].li_attr[k] = null),
                                          l && l.removeAttr(k));
                                }
                        if (
                            f[i] &&
                            f[i].a_attr !== b &&
                            "object" == typeof f[i].a_attr
                        )
                            for (k in f[i].a_attr)
                                    ...
                                    "class" === k
                                        ...
                                        : e[c.id].a_attr[k] ===
                                          ...
                                          ("href" === k
                                              ? ((e[c.id].a_attr[k] = "#"),
                                                m && m.attr("href", "#"))
                                              : (delete e[c.id].a_attr[k],
                                                m && m.removeAttr(k)));
                                }
                        if (
                            f[d].li_attr !== b &&
                            "object" == typeof f[d].li_attr
                        )
