...
test_pipeline = [
    dict(
        clip_len=56, num_clips=10, test_mode=True, type='UniformSampleFrames'),
    dict(type='PoseDecode'),
    dict(allow_imgpad=True, hw_ratio=1.0, type='PoseCompact'),
    dict(scale=(
        -1,
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file='data/ntu_custom_dataset.pkl',
            pipeline=[
                dict(clip_len=56, type='UniformSampleFrames'),
                dict(type='PoseDecode'),
                dict(allow_imgpad=True, hw_ratio=1.0, type='PoseCompact'),
                dict(scale=(
                    -1,
...
val_pipeline = [
    dict(clip_len=56, num_clips=1, test_mode=True, type='UniformSampleFrames'),
    dict(type='PoseDecode'),
    dict(allow_imgpad=True, hw_ratio=1.0, type='PoseCompact'),
    dict(scale=(
        -1,
